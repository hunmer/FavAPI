...
class CancelCollectWindowTest(unittest.TestCase):
    def test_continues_after_empty_refine_page(self):
        ...
        middle_cursor = _cursor("2025-06-22T07:44:22+08:00")
        ...
        responses = iter([
            ...
            {"items": [], "cursor": middle_cursor, "has_more": True},
            {"items": [], "cursor": before_window_cursor, "has_more": True},
            {"items": [], "cursor": before_window_cursor, "has_more": True},
        ])
        ...
        self.assertIn(
            {"matched_this_page": 1, "canceled": 1},
            [
                {"matched_this_page": event["matched_this_page"], "canceled": event["canceled"]}
                for event in events
            ],
        )
